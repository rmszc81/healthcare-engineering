...
public class CustomerCreateValidator : AbstractValidator<Healthcare.Engineering.DataObject.Data.CustomerDto>
{
    public CustomerCreateValidator(ValidatorSupport support)
    {
        RuleFor(r => r.Id)
            .NotEmpty().WithMessage("Id is required.")
            .MustAsync(async (id, _) => !await support.IdExists(id)).WithMessage("Id already exists.");
